...
from tumbler.apps.cta_strategy.strategies.factor_multi_period_v2_strategy import FactorMultiPeriodV2Strategy
...
def run():
    ...
    engine.set_parameters(vt_symbol=vt_symbol, interval=Interval.MINUTE.value,
                          ...
                          slippage=sllippage, size=1, price_tick=0.00000001,
                          capital=0, end=datetime(2021, 6, 29, 9, 50),
    ...
    engine.add_strategy(FactorMultiPeriodV2Strategy, setting)
