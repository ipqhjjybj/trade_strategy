...
from tumbler.apps.cta_strategy.strategies.factor_backtesting_strategy import FactorBacktestingStrategy
...
def run():
    ...
    engine.add_strategy(FactorBacktestingStrategy, setting)
    engine.load_data()
