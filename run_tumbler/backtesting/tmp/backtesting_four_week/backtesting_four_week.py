...
from tumbler.apps.cta_strategy.strategies.four_week_strategy import FourWeekStrategy
...
def run():
    ...
    engine.set_parameters(vt_symbol="btc_usdt.BINANCE", interval=Interval.MINUTE.value,
                          ...
                          slippage=10, size=1, price_tick=0.000001, capital=0, end=datetime(2020, 1, 29, 9, 50),
    ...
    engine.add_strategy(FourWeekStrategy, setting)
    engine.load_data()
