...
from tumbler.apps.market_maker.strategies.martin_analyse import MartinAnalyseStrategy
...
def run():
    ...
    slippage=0.00, size=1, price_tick=0.01, capital = 0, end = datetime(2019,12,29,9,50), mode = BacktestingMode.BAR.value)
    ...
    engine.add_strategy(MartinAnalyseStrategy, setting)
    engine.load_data()
