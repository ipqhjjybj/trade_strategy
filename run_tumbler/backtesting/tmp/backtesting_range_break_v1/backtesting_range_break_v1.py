...
from tumbler.apps.cta_strategy.strategies.range_break_v1_strategy import RangeBreakV1Strategy
...
def run():
    ...
    engine.set_parameters(vt_symbol="btc_usdt.BINANCE", interval=Interval.MINUTE.value,
                          start=datetime(2020, 1, 1, 8, 10), rate=0.001,
                          slippage=0, size=1, price_tick=0.01, capital=0, end=datetime(2020, 5, 1, 9, 50),
    ...
    engine.add_strategy(RangeBreakV1Strategy, setting)
