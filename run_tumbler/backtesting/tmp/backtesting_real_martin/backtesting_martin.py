...
from tumbler.apps.cta_strategy.strategies.martin_strategy import MartinStrategy
...
def run():
    ...
    engine.set_parameters(vt_symbol="btc_usdt.BINANCE", interval=Interval.MINUTE.value,
                          ...
                          slippage=0.00, size=1, price_tick=0.01, capital=0, end=datetime(2020, 4, 29, 9, 50),
    ...
    engine.add_strategy(MartinStrategy, setting)
    engine.load_data()
