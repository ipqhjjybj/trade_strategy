...
class Alphas(AlphaTemplate):
    # Alpha#1	 (rank(Ts_ArgMax(SignedPower(((returns < 0) ? stddev(returns, 20) : close), 2.), 5)) -0.5)
    def alpha001(self):
        '''
        0.0016592954117321701
        0.002006828272154339
        0.001504172139842081
        0.000890432839593716
        '''
        inner = self.close
    ...
    def alpha002(self):
        '''
        0.0006452999455132372
        0.0017200044609559713
        0.0016910879043117472
        0.0020043363525413505
        '''
    ...
    def alpha003(self):
        '''
        0.0011617375554115927
        0.0016639776498840457
        0.0012867780681318846
        0.001948235389894783
        '''
    ...
    def alpha004(self):
        '''
        -8.137443265876603e-05
        0.0010040371212670274
        0.0026203337639070057
        0.002517732210807038
        '''
    ...
    def alpha005(self):
        '''
        0.001967751831735071
        0.0009007633536461548
        0.0013032242871619194
        0.001888989190779161
        '''
    ...
    def alpha006(self):
        '''
        0.001576319813200792
        0.000880885697481962
        0.0015964165125504223
        0.0020071066400891295
        '''
    ...
    def alpha007(self):
        '''
        0.0004586865291271612
        0.00078507885358955
        0.0015095535992647208
        0.003307409681340875
        '''
    ...
    def alpha008(self):
        '''
        0.0012503554014379116
        0.0012440900354825759
        0.0015546690554910814
        0.0020116141709107366
        '''
    ...
    def alpha009(self):
        '''
        0.0013388716370749
        0.0015247710167270653
        0.0013197973919853645
        0.0018772886175349758
        '''
    ...
    def alpha010(self):
        '''
        0.0007400562444775176
        0.0016881358823299347
        0.0015473460468191714
        0.0020851904896956822
        '''
        delta_close = delta(self.close, 1)
    ...
    def alpha011(self):
        '''
        0.0023081773993077095
        0.0015454810352778044
        0.0009094961889343287
        0.001297574039802463
        '''
    ...
    def alpha012(self):
        '''
        0.0011159577254796973
        0.0016019372919933638
        0.0012963729622171639
        0.0020464606836320806
        '''
    ...
    def alpha013(self):
        '''
        0.0013926143588244343
        0.0014635084324260631
        0.001020738618646648
        0.00218386725342516
        '''
    ...
    def alpha014(self):
        '''
        0.0016905024520991849
        0.0010191058541018428
        0.001503772679093902
        0.0018473476780273756
        '''
    ...
    def alpha015(self):
        '''
        0.0013943177391629294
        0.0008268319454712602
        0.0018025985622421783
        0.002036980416445938
        '''
    ...
    def alpha016(self):
        '''
        0.001692299741124743
        0.0012640280894758362
        0.001023483680878149
        0.0020809171518435783
        '''
    ...
    def alpha017(self):
        '''
        0.00013498399525566115
        0.00112917298640979
        0.003079643680809655
        0.0017169280008471988
        '''
        adv20 = sma(self.volume, 20)
    ...
    def alpha018(self):
        '''
        0.0007234640818112228
        0.001383357822857204
        0.0015868563249498589
        0.0023670504337040196
        '''
    ...
    def alpha019(self):
        '''
        0.0008540005643353425
        0.0009157072860704058
        0.0025663673447682478
        0.0017246534681483097
        '''
    ...
    def alpha020(self):
        '''
        0.0016043823077097124
        0.0018736426158537259
        0.0015673909177817192
        0.001015312821977148
        '''
