...
from tumbler.function import parse_maxint_from_str, is_arr_sorted
...
class AlphaRankAutoProduce(AlphaTemplate):
    ...
    def __init__(self, df, population_num=300, canshu_nums=0, name="auto"):
        ...
        # assert evalfunc is not None, "Error, evalfunc should be set!"
        self._df = df
...
# from tumbler.alpha.alpha_rank_auto_produce import AlphaRankAutoProduce
#
# file_path = "/Users/szh/git/personal_tumbler/run_tumbler/tools/produce_csv_data/.tumbler/day.csv"
# df = pd.read_csv(file_path, index_col=[0, 2], skipinitialspace=True)
#
# df = MultiIndexMethod.get_filter_symbols(df, 365*2)
# a = AlphaAutoProduce(df, canshu_nums=0)
# a.run()
##
