...
class WebsocketClient(object):
    ...
    * on_error
    ...
    # ping_interval: int = 60, header: dict = None):
    ...
    def start(self):
        ...
        is connected successful.

        Please don't send packet until on_connected function is called.
        """
    ...
    def _ensure_connection(self):
        ...
        if triggered:
            log_service_manager.write_log("self.on_connected()")
            self.on_connected()
                ...
                try:
                    ...
                    if ws:
                        ...
                        try:
                            ...
                            log_service_manager.write_log("websocket unable to parse data: " + text)
                            raise e
    ...
    def on_connected():
        ...
        """
        log_service_manager.write_log("on_connected")
        # pass
