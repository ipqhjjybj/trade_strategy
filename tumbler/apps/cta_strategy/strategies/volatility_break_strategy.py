...
class VolatilityBreakStrategy(CtaTemplate):
    """
    ...
    """
    author = "ipqhjjybj"
    class_name = "VolatilityBreakStrategy"
    ...
    def __init__(self, mm_engine, strategy_name, settings):
        super(VolatilityBreakStrategy, self).__init__(mm_engine, strategy_name, settings)
