...
class CoinexRestMarketApi(RestClient):

    def __init__(self, gateway):
        super(CoinexRestMarketApi, self).__init__()
    ...
    def connect(self, key, secret, proxy_host="", proxy_port=0):
        ...
        self.gateway.write_log("CoinexRestMarketApi start success!")
    ...
    def query_depth(self, symbol, limit=10):
        self.add_request(
            method="GET",
            path="/v1/market/depth?market={}&limit={}&merge=0.00000001".format(
    ...
    def on_query_depth(self, data, request):
        ...
        tick.datetime = get_dt_use_timestamp(data['time'])
