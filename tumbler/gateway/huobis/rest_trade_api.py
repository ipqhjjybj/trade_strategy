...
from .base import REST_MARKET_HOST, REST_TRADE_HOST, parse_contract_info, parse_account_info
from .base import parse_position_holding, parse_order_info
from .base import get_huobi_future_system_format_symbol, get_from_huobi_to_system_format
from .base import DIRECTION_VT2HUOBIS, OFFSET_VT2HUOBIS, ORDERTYPE_VT2HUOBIS


class HuobisRestTradeApi(RestClient):
    """
    HUOBIS REST API
    """
    ...
    def connect(self, key, secret, proxy_host="", proxy_port=0):
        ...
        self.gateway.write_log("HuobisRestTradeApi start successily!")
        self.query_contract()
    ...
    def query_open_orders(self):
        for symbol in self.set_all_symbols:
            # Open Orders
            data = {"contract_code": get_huobi_future_system_format_symbol(symbol)}
    ...
    def query_complete_orders(self, list_order_ids):
        ...
        for symbol, sys_order_ids in orders_dic.items():
            if sys_order_ids:
                data = {
                    "contract_code": get_huobi_future_system_format_symbol(symbol),
    ...
    def on_query_position(self, data, request):
        ...
        for symbol, direction in all_position_sets:
            ...
            new_pos.exchange = Exchange.HUOBIS.value
